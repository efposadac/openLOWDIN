...
//  double Coul_Rep(double xa,double ya,double za,double norma,
...
void coul_rep_(double *xa,double *ya,double *za, int *la, double *alphaa, int *labela,
  ...
  // intsize = ncart[*la]*ncart[*lb]*ncart[*lc]*ncart[*ld];
  
  //DEBUG
  //   printf("origen A: %f %f %f \n", *xa, *ya, *za);
  //   printf("origen B: %f %f %f \n", *xb, *yb, *zb);
  //   printf("origen R: %f %f %f \n", *xc, *yc, *zc);
  //   printf("origen S: %f %f %f \n", *xd, *yd, *zd);
  //   printf("angular momentum: %d %d %d %d \n", *la, *lb, *lc, *ld);
  //   printf("exponents: %f %f %f %f \n", *alphaa, *alphab, *alphac, *alphad);
  //   printf("labels: %d %d %d %d \n", *labela, *labelb, *labelc, *labeld);

  //   std::cout<<"norder :"<<norder<<std::endl;  
  //   std::cout<<"intsize :"<<intsize<<std::endl;    
  
  //Allocate space for integrals buffer
  //integrals = (double *)calloc(intsize, sizeof(double));
  
  //Begin gaussian product
  A = *alphaa+*alphab;
  B = *alphac+*alphad;
	...
	for(int ncd=0; ncd<ncart[*ld]; ncd++) {	 
	  ...
	  if(pa <= pb && pc <= pd){	    
	    ...
	    if (  (apa != pa || apb!=pb || apc!=pc || apd!=pd) && ( *indexb==*indexs ) ){
	      ...
	      // 		 lindex[*la][nca][0], lindex[*la][nca][1], lindex[*la][nca][2], 
	      // 		 lindex[*lb][ncb][0], lindex[*lb][ncb][1], lindex[*lb][ncb][2], 
	      // 		 lindex[*lc][ncc][0], lindex[*lc][ncc][1], lindex[*lc][ncc][2], 
	      //		 lindex[*ld][ncd][0], lindex[*ld][ncd][1], lindex[*ld][ncd][2]);
	  ...
	  bcount = bcount + 1;
	  //std::cout<<"Counter2:   "<<bcount<<std::endl;
...
inline void Root6(int n, double XX)
{
  ...
  /* Local variables */
    ...
    extern /* Subroutine */     
      int rysasy_(int , double , double *, double *);
...
//     //printf("Hello world!\n");
//     /*****************************/
//     /*  integrating over primitives  */
//     /*****************************/

//     //primitive A
// //    double xa=0.0;            //Center X coordinate
// //    double ya=0.0;            //Center Y coordinate
// //    double za=0.0;            //Center Z coordinate
// //    double norma=1.0;         //Normalization factor
// //    int la=0;                 // Angular momentum un X
// //    int ma=0;                 // Angular momentum un Y
// //    int na=0;                 // Angular momentum un Z
// //    double alphaa=41.1;        //Exponent
  
//     //primitive A
//     double xa=0.5;            //Center X coordinate
//     double ya=0.0;            //Center Y coordinate
//     double za=0.0;            //Center Z coordinate
//     double norma=1.0;         //Normalization factor
//     int la=4;                 // Angular momentum
//     double alphaa=1.1;        //Exponent
...
// 	Col_int= coul_rep_(xa, ya, za, la,alphaa,
// 			   xb, yb, zb, lb,alphab,
// 			   xc, yc, zc, lc,alphac,
// 			   xd, yd, zd, ld,alphad);
//       }
...
//       cout<<"The integral is:   "<<Col_int[ii] <<"  expending "<<t_b-t_a<< endl;
//     }
//     // cout<<"length(Col_int): "<<81<<endl;
//     // cout<<"call to Recur: "<<nc_Recur<<endl;
//     // cout<<"call to Shift: "<<nc_Shift<<endl;
//     //for(int i=0; i<13;i++) cout<<roots[i]<<"    "<<weights[i]<<endl;

// //    /*****************************/
// //    /*  integrating over contractions*/
// //    /*****************************/
// //    double myArray [5] = {1.,2.0,3.,4.,5.};
// //
// //    int lena=4;
// //    double aexps[4]={13.01000000,1.962000000,0.4446000000,0.1220000000};
// //    double acoefs[4]={0.1968500000e-01,0.1379770000,0.4781480000,0.5012400000};
// //    double anorms[4]={1.0,1.0,1.0,1.0};
// //    xa=1.0;            //Center X coordinate
// //    ya=0.0;            //Center Y coordinate
// //    za=0.0;            //Center Z coordinate
// //    la=0;                 // Angular momentum un X
// //    ma=0;                 // Angular momentum un Y
// //    na=0;                 // Angular momentum un Z
// //
// //    int lenb=4;
// //    double bexps[4]={13.01000000,1.962000000,0.4446000000,0.1220000000};
// //    double bcoefs[4]={0.1968500000e-01,0.1379770000,0.4781480000,0.5012400000};
// //    double bnorms[4]={1.0,1.0,1.0,1.0};
// //    xb=-1.0;
// //    yb=0.0;
// //    zb=0.0;
// //    lb=0;
...
// //
// //    int lenc=4;
// //    double cexps[4]={13.01000000,1.962000000,0.4446000000,0.1220000000};
// //    double ccoefs[4]={0.1968500000e-01,0.1379770000,0.4781480000,0.5012400000};
// //    double cnorms[4]={1.0,1.0,1.0,1.0};
// //    xc=1.0;
// //    yc=0.0;
// //    zc=0.0;
// //    lc=0;
...
// //
// //    int lend=4;
// //    double dexps[4]={13.01000000,1.962000000,0.4446000000,0.1220000000};
// //    double dcoefs[4]={0.1968500000e-01,0.1379770000,0.4781480000,0.5012400000};
// //    double dnorms[4]={1.0,1.0,1.0,1.0};
// //    xd=-1.0;
// //    yd=0.0;
// //    zd=0.0;
// //    ld=8;
...
// //
// //
// //    double CInt= Contraction_Coul(lena,aexps,acoefs,anorms,
// //                  xa,ya,za,la,ma,na,lenb,bexps,bcoefs,bnorms,
// //                  xb,yb,zb,lb,mb,nb,lenc,cexps,ccoefs,cnorms,
// //                  xc,yc,zc,lc,mc,nc,lend,dexps, dcoefs,dnorms,
// //                  xd,yd,zd,ld,md,nd);
// //
// //                  cout<<"The integral for thi contraction is:   "<<CInt<< endl;
// //
