...
!!
module FirstDerivativeIntegrals_
  use Exception_
...
contains
  ...
  !! @version 1.0
  subroutine firstDerivativeIntegrals_computePrimitive(angularMomentIndexA, angularMomentIndexB, lengthA, lengthB, A, B, orbitalExponentsA, orbitalExponentsB, contractionCoefficientsA, contractionCoefficientsB, normalizationConstantA, normalizationConstantB, integralValue, ijob)
    implicit none
...
end module FirstDerivativeIntegrals_
