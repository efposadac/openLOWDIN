                    ...
                    do aa = occupationNumberOfSpeciesA + 1, activeOrbitalsOfSpeciesA
                      do ba = occupationNumberOfSpeciesA + 1, activeOrbitalsOfSpeciesA
                        ...
                        partialValue = partialValue &
                                       ...
                                       *(eigenValuesOfSpeciesA%values(ja) + eigenValuesOfSpeciesA%values(ka) - eigenValuesOfSpeciesA%values(aa) - eigenValuesOfSpeciesA%values(ba)))
                    ...
                    do ja = 1, occupationNumberOfSpeciesA
                      do ca = occupationNumberOfSpeciesA + 1, activeOrbitalsOfSpeciesA
                        ...
                        partialValue = partialValue &
                                       ...
                                       *(eigenValuesOfSpeciesA%values(ia) + eigenValuesOfSpeciesA%values(ja) - eigenValuesOfSpeciesA%values(ca) - eigenValuesOfSpeciesA%values(ba)))
