...
!>
!! @brief  The routines contained in this module generate
...
!April, 2000
!!! @author Felix Moncada
!! <b> Fecha de creacion : </b> 2022-02

module Lebedev_

  public :: Lebedev_angularGrid
...
contains
  ...
  subroutine Lebedev_angularGrid(x,y,z,w,np)
  !>
  !! @brief ! Get Lebedev grids
    ! x,y,z are arrays for the cartesian coordinates of points in a sphere with radius=1
    ! w are the weights for numerical integration
    ! np is the size of the grid, lebedevNumbers(1:32)=(/6,14,26,38,50,74,86,110,146,170,194,230,266,302,350,434,590,770,974,1202,1454,1730,2030,2354,2702,3074,3470,3890,4334,4802,5294,5810/)
 
  ! Based on Roberto Flores-Moreno, Aug 2008
    implicit none
    integer np
    real(8) x(*),y(*),z(*),w(*)
    ...
    case default
       stop 'Unknown Lebedev grid requested'
    end select
  end subroutine Lebedev_angularGrid
