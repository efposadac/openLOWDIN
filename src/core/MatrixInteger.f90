...
contains
  ...
  !>
  !! @brief Adds a new row with zeros at final of matrix
  !! @author J.M. Rodas
  !! <b> Creation date : </b> 2014-12-01
  subroutine MatrixInteger_addRow( this )
    implicit none
  ...
  end subroutine MatrixInteger_addRow
