...
module BasisSet_
  ...
  use CONTROL_
  use InputManager_ ! adicionado para leer seudopotenciales
  implicit none
...
contains
  ...
  !! @author E. F. Posada, 2013
  !! @version 1.0
  subroutine BasisSet_loadECP(this, basisName, ParticleName, origin, unit)
    implicit none
...
!    end select
  ...
  end subroutine BasisSet_loadECP
